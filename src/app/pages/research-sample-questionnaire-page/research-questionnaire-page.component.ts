...
@Component({
  ...
  templateUrl: './research-questionnaire-page.component.html',
  styleUrls: ['./research-questionnaire-page.component.css']
})
export class SampleQuestionnairePageComponent implements OnInit {
